    ...
    if markerIds is not None:
        ...
        if not len(markerIds) == 0:
            ...
            if not len(markerIds) == 0:
                ...
                # y_0 = tvecs[index][0][1]
                # z_0 = tvecs[index][0][2]
                # cv.putText(imageCopy, "Distances to Objects(m)", (300, 20), cv.FONT_HERSHEY_PLAIN, 1, (255, 0, 0, 0))
                ...
                #     cv.putText(imageCopy, msg, (300, 45 + 25 * i), cv.FONT_HERSHEY_PLAIN, 1, (255, 0, 0, 0))
